...
if test "$type" = "dr" ; then
  ...
  PRODOUANE_USER="$PRODOUANE_USER" PRODOUANE_PASS="$PRODOUANE_PASS" CVI="$cvi" PRODOUANE_ANNEE="$annee" PRODOUANE_OVNI="$PRODOUANE_OVNI" node puppeteer_scrapping/prodouane_vendanges.js
fi
