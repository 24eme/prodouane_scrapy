...
if test -f documents/dr-2019-"$PRODOUANE_DEBUG_DR".pdf ;  then echo " PDF Présent :)";  else 	echo "Erreur pas de pdf dr";  fi
if test -f documents/dr-2019-"$PRODOUANE_DEBUG_DR".html ; then echo " HTML Présent :)"; else    echo "Erreur pas de HTML dr"; fi
if test -f documents/dr-2019-"$PRODOUANE_DEBUG_DR".xls ;  then echo " XLS Présent :)";  else    echo "Erreur pas de xls dr";  fi
...
if test -f documents/sv11-2019-"$PRODOUANE_DEBUG_SV11".pdf ;  then echo " PDF Présent :)" ;  else echo "Erreur pas de pdf sv11";  fi
if test -f documents/sv11-2019-"$PRODOUANE_DEBUG_SV11".html ; then echo " HTML Présent :)" ; else echo "Erreur pas de html sv11"; fi
if test -f documents/sv11-2019-"$PRODOUANE_DEBUG_SV11".xls ;  then echo " XLS Présent :)" ;  else echo "Erreur pas de xls sv11";  fi
...
if test -f documents/sv12-2019-"$PRODOUANE_DEBUG_SV12".pdf  ; then echo " PDF Présent :)";  else echo "Erreur pas de pdf dr";  fi
if test -f documents/sv12-2019-"$PRODOUANE_DEBUG_SV12".html ; then echo " HTML Présent :)"; else echo "Erreur pas de html dr"; fi
if test -f documents/sv12-2019-"$PRODOUANE_DEBUG_SV12".xls  ; then echo " XLS Présent :)";  else echo "Erreur pas de xls dr";  fi
